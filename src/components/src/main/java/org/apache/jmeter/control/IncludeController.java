...
public class IncludeController extends GenericController implements ReplaceableController {
    ...
    public String getIncludePath() {
        ...
        String includePathValue = this.getPropertyAsString(INCLUDE_PATH);
        if(includePathValue.contains("${")){
            String getUserDefinedVariable = includePathValue.substring(includePathValue.indexOf("${"),includePathValue.indexOf("}"));
            String getUserDefinedValue = jMeterVariables.get(getUserDefinedVariable);
        }
        return includePathValue;
    }
